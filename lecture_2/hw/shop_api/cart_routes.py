...
from lecture_2.hw.store.models import Cart, CartItem, Item, CartResponse, ItemRequest, ItemResponse
...
async def get_carts(
    ...
    carts = store.get_carts(offset, limit, min_price, max_price, min_quantity, max_quantity)
